## Add **Has-A relationship** in current Design: 

Insted of having Product and Quantity map in warehouse we can use **Has-A relationship**, Inventory has Product then 
